...
class AccountMove(models.Model):
    ...
    def dte_documento(self):
        ...
        if DatosEmision.find("{http://www.sat.gob.gt/dte/fel/0.2.0}Frases") and factura.currency_id.is_zero(gran_total) and (factura.company_id.afiliacion_iva_fel or 'GEN') == 'GEN':
